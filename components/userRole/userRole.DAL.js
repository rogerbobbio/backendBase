...
function createUserRole(description, user_create) {    
        ...
        pool.getConnection( (err, connection) => {
         if (err) {
          reject( err )
            ...
            var sql = 'INSERT INTO user_role SET ?';
        ...
        pool.getConnection( (err, connection) => {
         if (err) {
          reject( err )
            ...
            var sql = 'UPDATE user_role SET ? WHERE id = ?';
          connection.query(sql, values, ( err, rows) => {
           if ( err ) {
            reject( err )
           } else {
        ...
        pool.getConnection( (err, connection) => {
         if (err) {
          reject( err )
            ...
            var sql = 'DELETE FROM user_role WHERE id = ?';
          connection.query(sql, userRoleId, ( err, rows) => {
           if ( err ) {
            reject( err )
           } else {
            resolve( rows )
        ...
        pool.getConnection( (err, connection) => {
         if (err) {
          reject( err )
            ...
            var sql = 'SELECT * FROM user_role WHERE description = ?';
